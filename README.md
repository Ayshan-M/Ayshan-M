...
- 🌱 Learning: Advanced AI ethics in policy frameworks.  
- 💬 Ask me about: Harmonizing datasets for SDGs or Salesforce automations.  
  ...
  <table>
    <tr>
      <td valign="top" width="33%">
        <h4>🚀 Leadership & Policy</h4>
        <ul>
          <li>🎯 Collective-Impact Facilitation</li>
          <li>📋 Policy Integration (Migration, Environment, SDGs)</li>
          <li>📊 Monitoring, Evaluation & Learning (MEL)</li>
        </ul>
      </td>
      <td valign="top" width="33%">
        <h4>📈 Data Science & Analysis</h4>
        <ul>
          <li>🐍 Python, R, scikit-learn, ML/AI</li>
          <li>📊 Tableau & Power BI Dashboards</li>
          <li>🗃️ SQL, SPSS, Data Cleaning & Harmonization</li>
        </ul>
      </td>
      <td valign="top" width="33%">
        <h4>🗺️ Digital Systems & GIS</h4>
        <ul>
          <li>⚡ Salesforce Admin, App Builder, Platform Dev I</li>
          <li>🗺️ ArcGIS Pro, QGIS</li>
          <li>🔧 Git, GitHub, CRM, Infographics & KM</li>
        </ul>
      </td>
    </tr>
  </table>
...
<div align="center">
  <table>
    <tr>
      <td width="50%">
        <details>
          <summary><b>👩‍💼 Director (Volunteer)</b> — Ottawa Neighbourhood Scientific Research Solutions</summary>
          <i>Strategic guidance on neighborhood-level data tools and interactive story maps. Driving community-led insights through geospatial storytelling.</i>
        </details>
      </td>
      <td width="50%">
        <details>
          <summary><b>🔬 Quantitative Researcher</b> — DEMA, CERC-University of Toronto</summary>
          <i>Harmonized multi-survey dataset (2,500+ cases), authored reports & infographics. Transformed raw data into actionable policy narratives.</i>
        </details>
      </td>
    </tr>
    <tr>
      <td width="50%">
        <details>
          <summary><b>📚 Policy, Research & Data Lead</b> — Ottawa Local Immigration Partnership</summary>
          <i>Co-authored Ottawa Immigration Strategy (2023–2027), led national research groups. Bridging data gaps for equitable migration policies.</i>
        </details>
      </td>
      <td width="50%">
        <details>
          <summary><b>🏢 Project Manager, Data Management</b> — FAO</summary>
          <i>Led global cloud-based data governance and management initiatives. Scaling sustainable data ecosystems worldwide.</i>
        </details>
      </td>
    </tr>
  </table>
...
> **Explore more:** Full CV and projects in pinned repositories or [Bold Profile](https://bold.pro/my/ayshanmammadzada/617r).  
...
- **MSc & BSc, Geography / Applied Ecology** — Baku State University (2011, 2014), Summa Cum Laude  
